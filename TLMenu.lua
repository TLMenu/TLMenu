...
keybinds, keybindMainConn = {}, nil
            ...
            function tw(obj, t, props, sty, dir)
            ...
            function twP(obj, t, props, sty, dir)
                if typeof(obj) ~= "Instance" then return { Play = function() end, Cancel = function() end } end
            ...
            task.spawn(function()
                local _ok_SmartBar, _err_SmartBar = pcall(function()
                    ...
                    function openBar()
                        ...
                        if not _ok then
                            warn("[TL DEBUG openBar] error: " .. tostring(_err))
                            warn("[TL DEBUG openBar] tw type: " .. type(tw))
                            warn("[TL DEBUG openBar] tabCardsHolder type: " .. typeof(tabCardsHolder))
                            warn("[TL DEBUG openBar] getPanelXAnchor type: " .. type(getPanelXAnchor))
                            warn("[TL DEBUG openBar] twP type: " .. type(twP))
                            warn("[TL DEBUG openBar] _TAB_BAR_W: " .. tostring(_TAB_BAR_W) .. " _TAB_BAR_H: " .. tostring(_TAB_BAR_H))
                        end
                    end
                    ...
                    do
                        local _exportEnv = (getgenv and getgenv()) or _G
                        _exportEnv.openBar = openBar
                        _exportEnv.closeBar = closeBar
                        _exportEnv.tabCardsHolder = tabCardsHolder
                    end
                    ...
                    fpsWidget.BackgroundColor3       = Color3.fromRGB(12, 12, 16)
                    fpsWidget.BackgroundTransparency = 0.35
                    ...
                    do
                        local c = Instance.new("UICorner", fpsWidget); c.CornerRadius = UDim.new(0, 10)
                    end

                    pcall(function()
                        local blur = Instance.new("UIBlur", fpsWidget)
                        blur.Name = "GlassBlur"
                        blur.Size = 20
                    end)

                    local fwInnerBg = Instance.new("Frame", fpsWidget)
                    fwInnerBg.Name = "InnerGlow"
                    fwInnerBg.Size = UDim2.new(1, 0, 1, 0)
                    fwInnerBg.BackgroundColor3 = C.panelBg or Color3.fromRGB(18, 18, 22)
                    fwInnerBg.BackgroundTransparency = 0.5
                    fwInnerBg.BorderSizePixel = 0
                    fwInnerBg.ZIndex = 20
                    pcall(function() Instance.new("UICorner", fwInnerBg).CornerRadius = UDim.new(0, 10) end)
                    local fwInnerGrad = Instance.new("UIGradient", fwInnerBg)
                    fwInnerGrad.Color = ColorSequence.new({
                    ...
                    fwStroke.Transparency = 0.25
                    fwStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
                    local fwStrokeGrad = Instance.new("UIGradient", fwStroke)
                    fwStrokeGrad.Color = ColorSequence.new({
                        ColorSequenceKeypoint.new(0, C.accent or Color3.fromRGB(0, 200, 255)),
                        ColorSequenceKeypoint.new(0.35, C.accent2 or Color3.fromRGB(0, 160, 220)),
                        ColorSequenceKeypoint.new(0.65, C.accent or Color3.fromRGB(0, 200, 255)),
                        ColorSequenceKeypoint.new(1, C.accent2 or Color3.fromRGB(0, 160, 220)),
                    })
                    fwStrokeGrad.Rotation = 45

                    local fwShadow = Instance.new("ImageLabel", fpsWidget)
                    fwShadow.Name = "DropShadow"
                    fwShadow.AnchorPoint = Vector2.new(0.5, 0.5)
                    fwShadow.Position = UDim2.new(0.5, 0, 0.5, 3)
                    fwShadow.Size = UDim2.new(1, 24, 1, 24)
                    fwShadow.BackgroundTransparency = 1
                    fwShadow.Image = "rbxassetid://1316045217"
                    fwShadow.ImageColor3 = Color3.fromRGB(0, 0, 0)
                    fwShadow.ImageTransparency = 0.55
                    ...
                    smartCapsule.BackgroundColor3 = Color3.fromRGB(16, 16, 20)
                    smartCapsule.BackgroundTransparency = 0.15
                    ...
                    local scStroke = Instance.new("UIStroke", smartCapsule)
                    scStroke.Thickness = 1
                    scStroke.Color = Color3.fromRGB(60, 60, 70)
                    scStroke.Transparency = 0.5
                    scStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
                    local smartGlow = Instance.new("ImageLabel", smartCapsule)
                    smartGlow.Name = "Glow"
                    smartGlow.AnchorPoint = Vector2.new(0.5, 0.5)
                    smartGlow.Position = UDim2.new(0.5, 0, 0.5, 0)
                    smartGlow.Size = UDim2.new(0, 40, 0, 40)
                    smartGlow.BackgroundTransparency = 1
                    smartGlow.Image = "rbxasset://textures/whiteCircle512.png"
                    smartGlow.ImageColor3 = C.accent or Color3.fromRGB(0, 200, 255)
                    smartGlow.ImageTransparency = 0.92
                    smartGlow.ScaleType = Enum.ScaleType.Fit
                    smartGlow.ZIndex = 20
                    ...
                    scIcon.ImageColor3 = Color3.fromRGB(200, 200, 210)
                    ...
                    scTlIcon.TextSize = 11
                    scTlIcon.TextColor3 = Color3.fromRGB(200, 200, 210)
                    ...
                    qaCapsule.BackgroundColor3 = Color3.fromRGB(16, 16, 20)
                    qaCapsule.BackgroundTransparency = 0.15
                    ...
                    local qaStroke = Instance.new("UIStroke", qaCapsule)
                    qaStroke.Thickness = 1
                    qaStroke.Color = Color3.fromRGB(60, 60, 70)
                    qaStroke.Transparency = 0.5
                    qaStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
                    local qaGlow = Instance.new("ImageLabel", qaCapsule)
                    qaGlow.Name = "Glow"
                    qaGlow.AnchorPoint = Vector2.new(0.5, 0.5)
                    qaGlow.Position = UDim2.new(0.5, 0, 0.5, 0)
                    qaGlow.Size = UDim2.new(0, 40, 0, 40)
                    qaGlow.BackgroundTransparency = 1
                    qaGlow.Image = "rbxasset://textures/whiteCircle512.png"
                    qaGlow.ImageColor3 = C.accent or Color3.fromRGB(0, 200, 255)
                    qaGlow.ImageTransparency = 0.92
                    qaGlow.ScaleType = Enum.ScaleType.Fit
                    qaGlow.ZIndex = 20
                    ...
                    qaIcon.ImageColor3 = Color3.fromRGB(200, 200, 210)
                    ...
                    qaTlIcon.TextSize = 11
                    qaTlIcon.TextColor3 = Color3.fromRGB(200, 200, 210)
                    ...
                    tlSmartHitbox.MouseEnter:Connect(function()
                        quickTween(smartCapsule, 0.18,
                            { BackgroundColor3 = Color3.fromRGB(14, 14, 18), Size = UDim2.fromOffset(30, 28), Position = UDim2.new(0, 3,
                                0.5, -14) })
                        quickTween(smartCapsuleCorner, 0.18, { CornerRadius = UDim.new(0, 8) })
                        quickTween(scTlIcon, 0.18, { TextSize = 13, TextColor3 = Color3.fromRGB(255, 255, 255) })
                        quickTween(scIcon, 0.18, { ImageColor3 = Color3.fromRGB(255, 255, 255) })
                        quickTween(smartGlow, 0.22, { ImageTransparency = 0.6 })
                        quickTween(scStroke, 0.18, { Color = C.accent or Color3.fromRGB(0, 200, 255), Transparency = 0.1 })
                    end)
                    tlSmartHitbox.MouseLeave:Connect(function()
                        quickTween(smartCapsule, 0.18,
                            { BackgroundColor3 = Color3.fromRGB(16, 16, 20), Size = UDim2.fromOffset(28, 28), Position =
                            UDim2.new(0, 4, 0.5, -14) })
                        quickTween(smartCapsuleCorner, 0.18, { CornerRadius = UDim.new(1, 0) })
                        quickTween(scTlIcon, 0.18, { TextSize = 11, TextColor3 = Color3.fromRGB(200, 200, 210) })
                        quickTween(smartGlow, 0.22, { ImageTransparency = 0.92 })
                        quickTween(scStroke, 0.18, { Color = Color3.fromRGB(60, 60, 70), Transparency = 0.5 })
                    end)
                    tlHitbox.MouseEnter:Connect(function()
                        quickTween(qaCapsule, 0.18,
                            { BackgroundColor3 = Color3.fromRGB(14, 14, 18), Size = UDim2.fromOffset(30, 28), Position = UDim2
                            .new(0, 35, 0.5, -14) })
                        quickTween(qaCapsuleCorner, 0.18, { CornerRadius = UDim.new(0, 8) })
                        quickTween(qaTlIcon, 0.18, { TextSize = 13, TextColor3 = Color3.fromRGB(255, 255, 255) })
                        quickTween(qaGlow, 0.22, { ImageTransparency = 0.6 })
                        quickTween(qaStroke, 0.18, { Color = C.accent or Color3.fromRGB(0, 200, 255), Transparency = 0.1 })
                    end)
                    tlHitbox.MouseLeave:Connect(function()
                        quickTween(qaCapsule, 0.18,
                            { BackgroundColor3 = Color3.fromRGB(16, 16, 20), Size = UDim2.fromOffset(28, 28), Position =
                            UDim2.new(0, 36, 0.5, -14) })
                        quickTween(qaCapsuleCorner, 0.18, { CornerRadius = UDim.new(1, 0) })
                        quickTween(qaTlIcon, 0.18, { TextSize = 11, TextColor3 = Color3.fromRGB(200, 200, 210) })
                        quickTween(qaGlow, 0.22, { ImageTransparency = 0.92 })
                        quickTween(qaStroke, 0.18, { Color = Color3.fromRGB(60, 60, 70), Transparency = 0.5 })
                    end)
                    ...
                    sepLine.ZIndex = 21
                    local sepGrad = Instance.new("UIGradient", sepLine)
                    ...
                    execSepLine.BackgroundTransparency = 0.65
                    execSepLine.BorderSizePixel = 0
                    execSepLine.ZIndex = 21
                    local execSepGrad = Instance.new("UIGradient", execSepLine)
                    execSepGrad.Transparency = NumberSequence.new({
                        NumberSequenceKeypoint.new(0, 0.6),
                        NumberSequenceKeypoint.new(0.5, 0),
                        NumberSequenceKeypoint.new(1, 0.6),
                    })
                    ...
                    execVal.TextStrokeTransparency = 0
                        ...
                        pcall(function()
                            fwInnerBg.BackgroundColor3 = Color3.fromRGB(12, 12, 16)
                        end)
                        pcall(function()
                        ...
                        pcall(function()
                            if smartGlow and smartGlow.Parent then
                                smartGlow.ImageColor3 = C.accent or Color3.fromRGB(0, 200, 255)
                            end
                        end)
                        pcall(function()
                        ...
                        pcall(function()
                            if fwInnerGrad and fwInnerGrad.Parent then
                                fwInnerGrad.Color = ColorSequence.new({
                                    ColorSequenceKeypoint.new(0, Color3.fromRGB(18, 18, 24)),
                                    ColorSequenceKeypoint.new(0.5, Color3.fromRGB(14, 14, 18)),
                                    ColorSequenceKeypoint.new(1, Color3.fromRGB(22, 22, 28)),
                    ...
                    local _fwBorderAcc = 0
                    _tlTrackConn(_SvcRS.Heartbeat:Connect(function(dt)
                        if not _tlAlive() then return end

                        _fwBorderAcc = _fwBorderAcc + dt * 18
                        if fwStrokeGrad and fwStrokeGrad.Parent then
                            fwStrokeGrad.Rotation = _fwBorderAcc % 360
                        end
                        ...
                        if _fwPingAcc >= _fwPingIval then
                            ...
                            if fwVal and fwVal.Parent then
                                pcall(function()
                                    quickTween(fwVal, 0.25, {TextColor3 = fpsCol})
                                    quickTween(fpsIcon, 0.25, {ImageColor3 = fpsCol})
                                end)
                                fwVal.Text = tostring(fps)
                            end
                            if pingVal and pingVal.Parent then
                                pcall(function()
                                    quickTween(pingVal, 0.25, {TextColor3 = pingCol})
                                end)
